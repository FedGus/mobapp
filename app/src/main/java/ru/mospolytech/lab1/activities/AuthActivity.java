...
public class AuthActivity extends AppCompatActivity {
    ...
    private void authLogin() {
        ...
        call.enqueue(new Callback<Auth>() { // асинхронный вызов 
            @Override
            //дальше должны получить ответ ассинхронный //стучимся к классу Auth
            public void onResponse(Call<Auth> call, Response<Auth> response) { // Метод вызывается, когда приходит ответ
                ...
                App appState = ((App)getApplicationContext()); //сохраняем наше состояние в App
                ...
                Intent intent = new Intent(AuthActivity.this, MainActivity.class); //Intent открытие нового окна
